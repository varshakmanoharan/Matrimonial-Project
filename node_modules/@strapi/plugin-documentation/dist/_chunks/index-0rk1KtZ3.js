...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-i2Gcdt38.js"));
        return component;
      }
    });
    app.registerPlugin({
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-Tr29VJFE.js"));
        return component;
      },
      permissions: PERMISSIONS.main
    });
...
//# sourceMappingURL=index-0rk1KtZ3.js.map
