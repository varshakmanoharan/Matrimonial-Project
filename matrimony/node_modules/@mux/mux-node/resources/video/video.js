...
const DRMConfigurationsAPI = __importStar(require("@mux/mux-node/resources/video/drm-configurations"));
...
class Video extends resource_1.APIResource {
    constructor() {
        ...
        this.webInputs = new WebInputsAPI.WebInputs(this._client);
        this.drmConfigurations = new DRMConfigurationsAPI.DRMConfigurations(this._client);
    }
}
exports.Video = Video;
(function (Video) {
    ...
    Video.WebInputs = WebInputsAPI.WebInputs;
    Video.WebInputListResponsesBasePage = WebInputsAPI.WebInputListResponsesBasePage;
    Video.DRMConfigurations = DRMConfigurationsAPI.DRMConfigurations;
    Video.DRMConfigurationsBasePage = DRMConfigurationsAPI.DRMConfigurationsBasePage;
